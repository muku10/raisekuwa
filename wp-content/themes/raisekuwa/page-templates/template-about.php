...
<main>
	...
	<!-- Story Section -->
	<?php $img_base = esc_url( get_template_directory_uri() ) . '/assets/images/'; ?>
		...
		<div class="container grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
			<div class="reveal-left" style="transition-delay: 0ms;">
				<div class="relative aspect-[4/5] overflow-hidden shadow-card">
					<img src="<?php echo $img_base; ?>about-chef-DB7vu_D2.jpg" alt="Chef grilling sekuwa over charcoal" loading="lazy" class="w-full h-full object-cover">
					<div class="absolute -bottom-6 -right-6 bg-gradient-fire text-primary-foreground p-6 lg:p-8 max-w-[220px] shadow-fire"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-flame w-8 h-8 mb-3"><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z"></path></svg>
						<p class="font-serif text-2xl leading-tight">Charcoal grilled, every single skewer.</p>
					</div>
				</div>
			</div>
			<div class="reveal-right" style="transition-delay: 150ms;"><span class="text-primary uppercase text-xs tracking-[0.4em]">Our Story</span>
				<h2 class="font-serif text-4xl sm:text-5xl lg:text-6xl mt-4 mb-6">A taste of <span class="text-gradient-fire">home</span>, far from home.</h2>
				<p class="text-foreground/75 text-lg leading-relaxed mb-5">Rai's Sekuwa Corner began with a simple promise — to bring the bold, smoky flavours of Nepali street food to Australia, without shortcuts. Every momo is folded by hand. Every sekuwa is marinated overnight and grilled over real charcoal.</p>
				<p class="text-muted-foreground leading-relaxed mb-8">From our kitchen in Southport to your table, our recipes carry the warmth of family, the depth of generations-old spice blends, and the soul of authentic Nepali street food.</p>
