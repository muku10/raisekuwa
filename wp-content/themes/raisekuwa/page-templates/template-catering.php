...
<main>
	...
	<section class="relative pt-40 pb-24 lg:pt-52 lg:pb-32 overflow-hidden text-white">
		...
		<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/float-chili-D48owxuK.png" 
			 ...
			 class="pointer-events-none select-none will-change-transform absolute top-24 right-10 w-24 opacity-70"
			 style="transform: translate3d(0px, 0px, 0px) rotate(-63.7deg); transition: transform 0.6s cubic-bezier(0.22, 1, 0.36, 1);">
		
		<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/float-tomato-CXuafqOm.png" 
			 alt="" aria-hidden="true" 
			 class="pointer-events-none select-none will-change-transform absolute bottom-12 left-10 w-20 opacity-60"
			 style="transform: translate3d(0px, 0px, 0px) rotate(-0.3deg); transition: transform 0.6s cubic-bezier(0.22, 1, 0.36, 1);">
