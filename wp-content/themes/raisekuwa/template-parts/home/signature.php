...
$static_dishes = [
	[ 'img' => $img_base . 'dish-buff-sukuti-BPkB_9x8.jpg',      'alt' => 'Buff Sukuti',    'category' => 'Charcoal BBQ',   'title' => 'Buff Sukuti' ],
	[ 'img' => $img_base . 'dish-steamed-momo-eaA_C0vV.jpg',     'alt' => 'Jhol Momo',      'category' => 'Hand Folded',    'title' => 'Jhol Momo' ],
	[ 'img' => $img_base . 'dish-chow-mein-B1YWKp4U.jpg',        'alt' => 'Chow Mein',      'category' => 'Comfort Bowls',  'title' => 'Chow Mein' ],
	[ 'img' => $img_base . 'dish-chilli-chicken-B3EF2eZr.jpg',   'alt' => 'Chilli Chicken', 'category' => 'Bold Flavours',  'title' => 'Chilli Chicken' ],
];
?>
		...
		<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
			...
			<?php if ( have_rows( 'signature_plates' ) ) : ?>
				...
				<?php $i = 0; while ( have_rows( 'signature_plates' ) ) : the_row(); ?>
					...
					$link     = esc_url( get_sub_field( 'link' ) ?: site_url( '/menu' ) );
					$delay    = $i * 100;
					$i++;
					?>
